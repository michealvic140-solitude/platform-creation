...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Lomita Shooters League — Virtual Token Shooting League" },
      { property: "og:description", content: "Live matches, gang leaderboards and virtual-token wagering for the Lomita Shooters League." },
      ...
      { name: "twitter:title", content: "Lomita Shooters League — Virtual Token Shooting League" },
      { name: "twitter:description", content: "Live matches, gang leaderboards and virtual-token wagering for the Lomita Shooters League." },
