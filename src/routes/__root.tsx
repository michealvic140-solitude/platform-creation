...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Live virtual shooting matches, gang leaderboards, and token-only wagering at the Lomita Shooters League." },
      ...
      { name: "twitter:description", content: "Live virtual shooting matches, gang leaderboards, and token-only wagering at the Lomita Shooters League." },
